...
export interface OpenAPIParameterObject {
  ...
  schema?: JSONSchema | ZodType | undefined;
}
...
// TODO: An example of TS error in case "exactOptionalPropertyTypes": true is not set in dependency type downstream.
...
//   Type 'undefined' is not assignable to type 'ServerAdapterPlugin<TServerContext>[]'.ts(2430)
...
export type RouterComponentsBase = {
  // TODO: Looks like undefined could not be mapped in FromRouterComponentSchema type, so maybe schemas should not be optional?
...
> = TRouter extends Router<any, any, infer TRouterSDK>
  ? TRouterSDK[TPath][TMethod] extends (requestParams?: infer TRequestParams | undefined) => any
    ? TRequestParams extends {
        [TParamTypeKey in TParamType]?: infer TParamTypeValue | undefined;
      }
      ? TParamTypeValue
      : never
    : never
