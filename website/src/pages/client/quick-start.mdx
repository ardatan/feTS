...
import { createClient, ResolveRefsInObj } from 'fets'
import openapi from './openapi'

const client = createClient<ResolveRefsInObj<typeof openapi>>()
...
If you are using [feTS Server](/server/quick-start) and share the types of your router instance. You can infer
