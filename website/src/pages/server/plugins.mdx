import { Callout, LegacyCommand, TabSelector, TabSet } from '@theguild/components'
...
<Callout type="info">
**How do middlewares differ from extensions?**
...
response for CORS or cookies, and so forth, we require extensions that can intercept the final
response before it is received by the client.
