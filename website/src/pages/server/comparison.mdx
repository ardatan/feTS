...
| Non-TS clients | Any OpenAPI client works           | Needs a custom client or adapter    |
| Validation     | TypeBox / JSON Schema              | Zod (typical)                       |
| Bundle focus   | Thin Fetch-based client            | Heavier client runtime for features |
...
need a public OpenAPI document.
