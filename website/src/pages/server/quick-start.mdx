...
<LegacyPackageCmd packages={['fets', 'uWebSockets.js@uNetworking/uWebSockets.js#v20.30.0']} />
...
<Callout>
  If you still want to use `node:http`, see [node:http integration recipe](/integrations/node-http)
</Callout>
