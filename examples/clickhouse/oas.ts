// This file is generated by fets-cli
...
export default {
  ...
  "info": {
    ...
    "contact": {
      ...
      "url": "https://clickhouse.com/docs/en/cloud/manage/openapi?referrer=openapi-77076",
    ...
    "schemas": {
      ...
      "ApiKeyHashData": {
        "properties": {
          ...
          "keyIdSuffix": {
            "type": "string",
            "description": "Last 4 digits of the key ID. Algorithm: sha256sum | tr -d '-' | xxd -r -p | base64"
          },
          "keySecretHash": {
            "type": "string",
            "description": "Hash of the key secret. Algorithm: sha256sum | tr -d '-' | xxd -r -p | base64"
          }
        }
      },
      ...
      "ServicePasswordPatchRequest": {
        "properties": {
          "newPasswordHash": {
            "type": "string",
            "description": "Optional password hash. Used to avoid password transmission over network. If not provided a new password is generated and is provided in the response. Otherwise this hash is used. Algorithm: sha256sum | tr -d '-' | xxd -r -p | base64"
          }
        }
      },
